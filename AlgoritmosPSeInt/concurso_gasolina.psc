Algoritmo p5_5
	...
	Imprimir "Entre estos lugares hay cierto número de gasolineras y el auto tiene un limite de distancia recorrida usando el tanque lleno K." 
	...
	Imprimir "Ingrese la distancia máxima del tanque en [Km]" 
	Leer K
	Si K>0
		...
		Dtemp=0.0
		i=1
		//Primero debemos asegurarnos de ubicar las gasolineras dentro de la distancia D
		Mientras Dtemp<D
			Si i MOD 2 !=0
				M[i]=0.05*K*i-0.01*K
				Dtemp=Dtemp+M[i]
		...
		FinSi
	SiNo
		Imprimir "La distancia debe ser positiva mayor que cero."
	FinSi
